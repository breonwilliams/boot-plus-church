...
if ( ! function_exists('staff_card') ) {
    function staff_card( $atts ){
        ...
        $class = $atts['class'];
        $column = $atts['column'];
        $img_column = $atts['img_column'];
        $content_column = $atts['content_column'];
        $pagination = $atts['pagination'];
        ...
        if($query->have_posts()) : $output;
            ...
            while ($query->have_posts()) : $query->the_post();
                ...
                if ( has_post_thumbnail() ) {
                    ...
                    $output .= '<a href="' . get_permalink() . '" title="' . the_title('','',false) . '">';
                    $output .= get_the_post_thumbnail( get_the_id(), 'post_thumbnail_square', array('class' => 'img-responsive pull-left'));
                    $output .= '<div class="clearfix"></div>';
                    $output .= '</a>';
...
add_shortcode('staff_card', 'staff_card');
